...
import kotlinx.android.synthetic.main.fragment_oper_head.*
...
class OperHeadFragment : Fragment() {
    ...
    private fun start(){
        ...
        findNavController().navigate(OperHeadFragmentDirections.actionOperHeadFragmentToOperSumFragment(operation))
    }
