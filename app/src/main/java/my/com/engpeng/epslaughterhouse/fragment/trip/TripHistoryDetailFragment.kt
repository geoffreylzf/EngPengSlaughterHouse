            ...
            R.id.mi_print -> {
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    withContext(Dispatchers.Main) {
                        findNavController().navigate(TripHistoryDetailFragmentDirections.actionTripHistoryDetailFragmentToPrintPreviewFragment(printText))
                    }
                }
                true
            }
...
class DetailAdapter(private val detailList: List<TripDetail>)
