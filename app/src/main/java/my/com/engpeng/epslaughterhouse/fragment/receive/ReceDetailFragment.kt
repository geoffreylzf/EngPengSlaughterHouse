...
import kotlinx.android.synthetic.main.fragment_rece_detail.*
...
class ReceDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_rece_detail, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        houseStr = ReceDetailFragmentArgs.fromBundle(arguments!!).houseStr
        setupRb()
        setupView()
        setupRv()
    }
    ...
    private fun save() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            appDb.tempShReceiveDetailDao().insert(tempReceDetail)
